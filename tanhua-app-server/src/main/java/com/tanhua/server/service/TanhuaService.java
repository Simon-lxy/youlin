...
//    }
    ...
    public void likeUser(Long likeUserId) {
        ...
        redisTemplate.opsForSet().add(Constants.USER_LIKE_KEY + UserHolder.getUserId().toString(), likeUserId.toString());
        //3、判断是否双向喜欢
    ...
    public void notLikeUser(Long likeUserId) {
        ...
        redisTemplate.opsForSet().remove(Constants.USER_LIKE_KEY + UserHolder.getUserId().toString(), likeUserId.toString());
