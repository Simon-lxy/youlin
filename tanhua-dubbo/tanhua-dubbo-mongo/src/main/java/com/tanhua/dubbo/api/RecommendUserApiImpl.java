...
public class RecommendUserApiImpl  implements RecommendUserApi {
    ...
    public List<RecommendUser> queryCardsList(Long userId, int counts) {
        ...
        TypedAggregation<RecommendUser> newAggregation = TypedAggregation.newAggregation(RecommendUser.class, TypedAggregation.match(criteria), TypedAggregation.sample(counts));
